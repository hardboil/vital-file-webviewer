...
```
┌─────────────────────────────────────────────────────────────────┐
│   [Minimap: 전체 파형 미리보기 + 클릭/드래그로 탐색]             │
│   [현재 위치 하이라이트, 이벤트/마커 표시]                        │
├─────────────────────────────────────────────────────────────────┤
...
> **Note**: Timeline Slider가 Minimap으로 통합됨 (Phase 6)
...
> **Note**: Local Data Files 옵션은 Phase 5에서 제거됨
...
- 부서 (Department) ✅
- Case ID 검색 ✅
- 나이 범위 (Age Range) ✅ - Dual-thumb 슬라이더
- 성별 (Sex) ✅
- ASA 등급 ✅ - 1~5 등급 (색상 배지 표시)
...
├──────────────────────────────────────────────────────────────┤
│  ⚙ 필터                                                      │
│  Search: [Case ID or operation name  ]                       │
│  Department: [All ▼]  Sex: [All ▼]  ASA: [All ▼]            │
│  Age: [0]──────────────────────[120]       10,234 matches    │
├──────────────────────────────────────────────────────────────┤
│  ┌────────────────────────────────────────────────────────┐  │
│  │ Case 0001  │ M/45 │ ASA 2 │ General Surgery            │  │
│  │ Case 0002  │ F/62 │ ASA 3 │ Cardiac Surgery            │  │
│  │ ...                                                    │  │
│  └────────────────────────────────────────────────────────┘  │
└──────────────────────────────────────────────────────────────┘
```
